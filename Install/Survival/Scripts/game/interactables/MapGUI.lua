...
local SubGuiIsOn = false
local SubGuiIsOn1 = false
local SubGuiIsOn2 = false
local SubGuiIsOn3 = false
...
MapGUI.Levels = {
	["L1"] = { maxConnections = 2, upgrade = L2, cost = 1, title = "LEVEL 1", unlock = { Satellites = "+1", Distance="+250" } },
	["L2"] = { maxConnections = 4, upgrade = L3, cost = 2, title = "LEVEL 2", unlock = { Satellites = "+2", Distance="+500" } },
	["L3"] = { maxConnections = 6, upgrade = L4, cost = 4, title = "LEVEL 3", unlock = { Satellites = "+4", Distance="+750" } },
	["L4"] = { maxConnections = 8, upgrade = L5, cost = 5, title = "LEVEL 4", unlock = { Satellites = "+5", Distance="+1,000" } },
	["L5"] = { maxConnections = 10, title = "LEVEL 5" }
}
...
function cl_MapGuiOn( self, tool, playerName)
...
function MapGUI.client_onAction(self, input, active)
	...
	if (input == 19 and SubGuiIsOn == false and SubGuiIsOn1 == false and SubGuiIsOn2 == false and SubGuiIsOn3 == false and not MapGUI.SatelliteLaunched) then
		if sm.localPlayer.getPlayer():getCharacter() ~= nil then
			sm.localPlayer.getPlayer():getCharacter():setLockingInteractable( nil )
		end
		if MapGUI.Hidegui ~= nil then
	...
	if (input == 5) and SubGuiIsOn3 == false and active and SubGuiIsOn == false  and SubGuiIsOn1 == false and SubGuiIsOn2 == false and MapGUI.ButtonHasBeenCalled == false then
		self:cl_UpgradeCreate()
		MapGUI.ButtonHasBeenCalled = true
	elseif (input == 5) and SubGuiIsOn3 == true and not active then
		self:cl_onGuiClosed()
		SubGuiIsOn3 = false
	elseif (input == 5) and SubGuiIsOn3 == false and not active then
		SubGuiIsOn3 = true
		MapGUI.ButtonHasBeenCalled = false
	end
	if (input == 6) and SubGuiIsOn == false and active and SubGuiIsOn1 == false  and SubGuiIsOn2 == false and SubGuiIsOn3 == false and MapGUI.ButtonHasBeenCalled == false then
		self:cl_setupUiCreate()
		MapGUI.ButtonHasBeenCalled = true
	elseif (input == 6) and SubGuiIsOn == true and not active then
		self:cl_onGuiClosed()
		SubGuiIsOn = false
	elseif (input == 6) and SubGuiIsOn == false and not active then
		SubGuiIsOn = true
		MapGUI.ButtonHasBeenCalled = false
	end
	if (input == 7) and SubGuiIsOn == false and active and SubGuiIsOn1 == false  and SubGuiIsOn2 == false and SubGuiIsOn3 == false and MapGUI.ButtonHasBeenCalled == false then
		self:cl_setupUiDestroy()
		MapGUI.ButtonHasBeenCalled = true
	elseif (input == 7) and SubGuiIsOn1 == true and not active then
		self:cl_onGuiClosed()
		SubGuiIsOn1 = false
	elseif (input == 7) and SubGuiIsOn1 == false and not active then
		SubGuiIsOn1 = true
		MapGUI.ButtonHasBeenCalled = false
	end
	if (input == 8) and SubGuiIsOn == false and active and SubGuiIsOn1 == false  and SubGuiIsOn2 == false and SubGuiIsOn3 == false and MapGUI.ButtonHasBeenCalled == false then
		self:cl_setupUiDestroyAll()
		MapGUI.ButtonHasBeenCalled = true
	elseif (input == 8) and SubGuiIsOn2 == true and not active then
		self:cl_onGuiClosed()
		SubGuiIsOn2 = false
	elseif (input == 8) and SubGuiIsOn2 == false and not active then
		SubGuiIsOn2 = true
		MapGUI.ButtonHasBeenCalled = false
	end
	--[[
...
function MapGUI.client_onFixedUpdate( self, dt )
	if MapGUI.PlayerName == sm.localPlayer.getPlayer():getName() then
		if CountForIconBool and not MapGUI.SatelliteLaunched and SubGuiIsOn3 and self.gui ~= nil then
...
---------GUI-Modules--------------------------------------
 ...
 function MapGUI.cl_UpgradeCreate( self )
	...
	if MapLevel < 4 then
		...
		local infoData = MapGUI.Levels["L"..tostring(MapLevel+1)].unlock
...
function MapGUI.cl_MapUpgrade( self, params )
 ...
 function MapGUI.cl_selectColorCreate( self )
	...
	self.gui:setSliderData( "Setting", 9, 3 )
